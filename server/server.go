...
func (s *stackCalcServer) CreateCalc(ctx context.Context,
	create *pb.CreateCalcRequest) (*pb.CreateCalcResponse, error) {
...
func (s *stackCalcServer) DestroyCalc(ctx context.Context,
	destroy *pb.DestroyCalcRequest) (*pb.DestroyCalcResponse, error) {
	fmt.Println("Received DestroyCalc", destroy)
	delete(s.calcs, destroy.CalcId)
	return &pb.DestroyCalcResponse{}, nil
}

func (s *stackCalcServer) ListCalcs(ctx context.Context,
	list *pb.ListCalcsRequest) (*pb.ListCalcsResponse, error) {
...
func (s *stackCalcServer) EvaluateStatement(ctx context.Context,
	eval *pb.EvaluateStatementRequest) (*pb.EvaluateStatementResponse, error) {
...
func (s *stackCalcServer) GetState(ctx context.Context,
	get *pb.GetStateRequest) (*pb.GetStateResponse, error) {
